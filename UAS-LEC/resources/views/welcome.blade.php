    ...
    <div class="container mx-auto px-6 md:px-24">
        ...
        <div class="mb-24">
            ...
            <div class="flex flex-col md:flex-row items-center md:items-start justify-between space-y-8 md:space-y-0">
                <!-- Visi -->
                <div class="w-full md:w-1/2">
                    <h3 class="text-2xl font-semibold text-black mb-4">Visi</h3>
    ...
    <section id="program" class="section py-20 bg-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="p-10 flex flex-col bg-gray-50 rounded-lg items-center text-center">
                ...
                <h3 class="text-2xl font-semibold text-black text-center">Tahap 1: Balita</h3>
                <h3 class="text-2xl font-semibold text-black mb-4 text-center">0-5 tahun</h3>
            </div>
            <div class="p-10 bg-gray-50 flex flex-col rounded-lg items-center text-center">
                ...
                <h3 class="text-2xl font-semibold text-black text-center">Tahap 2: Namdulasta</h3>
                <h3 class="text-2xl font-semibold text-black mb-4 text-center">6-12 tahun</h3>>
            </div>
            <div class="p-10 bg-gray-50 flex flex-col rounded-lg items-center text-center">
                ...
                <h3 class="text-2xl font-semibold text-black text-center">Tahap 3: Gapanlasta</h3>
                <h3 class="text-2xl font-semibold text-black mb-4 text-center">13-18 tahun</h3>>
            </div>
        </div>
    </div>
    </div>
...
<!-- Galeri -->
<section id="galeri" class="section py-20 bg-gray-50">
    <div class="container mx-auto px-6 ">
        <!-- Section Title -->
