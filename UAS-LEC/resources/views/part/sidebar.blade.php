...
<nav id="sidebar">
  <ul>
    ...
    <li>
      <a href="{{ route('ManageUser') }}" class="flex items-center">
        ...
        <span class="menu-text text-white">Manage Account</span>
      </a>
    </li>
    <li>
      ...
      <ul class="sub-menu">
        <div>
          ...
          <li><a href="{{Route('show.kalender')}}">Kalender</a></li>
        </div>
      </ul>
    </li>
    <li>
      <a href="{{ Route('show.donasi') }}" class="flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <span class="menu-text text-white">List Donasi</span>
      </a>
    </li>
    <li>
    ...
    <li>
      <a href="{{ Route('welcome') }}">
        ...
        <span class="menu-text">Return to Web page</span>
      </a>
    </li>
