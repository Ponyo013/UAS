...
<section class="section py-4 mx-auto mt-36 mb-24 rounded-lg overflow-hidden max-w-screen-xl w-full">
    <div class="bg-gray-100 pb-12" style="border-radius: 20px;">
        <div class="bg-[#CC2B52] grid grid-cols-4 sm:grid-cols-4 md:grid-cols-4 mb-10 mt-2 justify-items-center text-center" style="border-top-left-radius: 20px; border-top-right-radius: 20px;">
        ...
        <div id="profil" class="content grid grid-cols-1 gap-4 justify-items-center text-center">
            <div class="grid grid-cols-1 sm:grid-cols-1 gap-4 w-full px-12">
                ...
                <div class="p-4">
                    ...
                    Panti Asuhan Tunas Mahardika didirikan pada tanggal 28 Oktober 2005 berdasarkan Akte Notaris no.17, 
